...
The React app now defaults to the local backend URL `http://localhost:8080/api`. To use the shared VM instead, set `REACT_APP_API_BASE_URL=http://<VM_EXTERNAL_IP>:8080/api`.
